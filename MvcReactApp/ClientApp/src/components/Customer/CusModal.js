...
class ProModal extends Component {
    ...
    render() {
        ...
        let editModal = <Modal open={this.props.isOpen}
            ...
            <Modal.Header>Customer Record</Modal.Header>
            <Modal.Content>
                <Form>
                    <input hidden readOnly value={this.props.id} />
                    <Form.Field inline>
                        <label>Name</label>
                        <Form.Input placeholder='Customer Name' value={this.props.name} onChange={this.props.handleName} error={this.props.nameError} />
                    </Form.Field>
                    <Form.Field>
                    ...
                    <Form.Field inline>
                        <label>Address</label>
                        <Form.Input placeholder='Customer Address' value={this.props.address} onChange={this.props.handleaddress} error={this.props.addressError} />
                    </Form.Field>
                    <Form.Field>
        ...
        let deleteModal = <Modal size='tiny' open={this.props.isDelOpen} onClose={this.props.isDelClose}>
            <Modal.Header>Delete Customer Record</Modal.Header>
            <Modal.Content>
